...
resource "aws_acm_certificate" "my_certificate_request" {
  domain_name               = data.aws_route53_zone.route53_domain.name
  subject_alternative_names = ["*.${data.aws_route53_zone.route53_domain.name}"]
...
#===============================================================
# CNAME record returned by ACM to be inserted into hosted zone
#===============================================================
